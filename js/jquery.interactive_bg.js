 ...
 * License: GPL v3
 *
 * REVISED: 20FEB2017, ALEXANDER VALLOROSI
 * ========================================================== */
  ...
  $.fn.interactive_bg = function(options){
    return this.each(function(){
      ...
      if (settings.wrapContent == false) {
        el.prepend("<div class='ibg-bg'><h2>⚡️Alexander Vallorosi</h2></div>")
      } else {
        el.wrapInner("<div class='ibg-bg'><h2>⚡️Alexander Vallorosi</h2></div>")
      }
